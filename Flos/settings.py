"""
Django settings for Flos project.
...
SECRET_KEY = 'django-insecure-6m4%aore@9l)g5czek$^st(%3%u=(pkqx6^$_2!(^km*b)beyu'
...
WSGI_APPLICATION = 'Flos.wsgi.application'
